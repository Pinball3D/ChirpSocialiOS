                    ...
                    VStack(alignment: .center) {
                        ...
                        HStack {
                            ...
                            if profile != Utility().getUser() {
                                ...
                                }.buttonStyle(.borderedProminent).foregroundStyle(isFollowing ? .accent : .black).tint(isFollowing ? .gray.opacity(0.5) : .accent).font(themeManager.currentTheme.UIFont.value)
                            }
                            if devMode {
                                NavigationLink {
                        ...
                        HStack {
                            Text(Utility.shared.parseForTwemoji(AttributedString(profile!.bio))).font(themeManager.currentTheme.UIFont.value)
                            Spacer()
                        }.padding(.horizontal)
                        HStack {
                            ...
                            Spacer()
                        }.font(themeManager.currentTheme.UIFont.value).foregroundStyle(.secondary).padding(.top).padding(.horizontal)
